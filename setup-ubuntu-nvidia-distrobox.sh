...
sudo apt install -y libxcb-cursor0 xorg xauth x11-apps mesa-utils libxcb-xinerama0 libxkbcommon-x11-0 libxcb-util1 libxcb-icccm4 libxcb-image0 libxcb-keysyms1 libxcb-render-util0
